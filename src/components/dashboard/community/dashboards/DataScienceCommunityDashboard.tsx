      ...
      <div className="container mx-auto p-4 sm:p-6 w-full max-w-none">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full sm:w-auto">
                <div className="p-3 rounded-full bg-kic-green-100 flex-shrink-0">
                  <BarChart3 className="h-6 w-6 sm:h-8 sm:w-8 text-kic-green-600" />
                </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
            ...
            <CardContent className="p-3 sm:p-4">
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
                ...
                <div className="text-center sm:text-left">
                  <p className="text-xs sm:text-sm text-kic-gray/70">Datasets</p>
                  <p className="text-lg sm:text-lg font-semibold text-kic-gray">89</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-kic-green-200 bg-white/80 backdrop-blur-sm shadow-lg border-0">
            <CardContent className="p-3 sm:p-4">
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
                <Brain className="h-5 w-5 sm:h-6 sm:w-6 text-kic-green-600 flex-shrink-0" />
                <div className="text-center sm:text-left">
                  <p className="text-xs sm:text-sm text-kic-gray/70">ML Models</p>
                  <p className="text-lg sm:text-lg font-semibold text-kic-gray">23</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-kic-green-200 bg-white/80 backdrop-blur-sm shadow-lg border-0">
            <CardContent className="p-3 sm:p-4">
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
                <BarChart3 className="h-5 w-5 sm:h-6 sm:w-6 text-kic-green-600 flex-shrink-0" />
                <div className="text-center sm:text-left">
                  <p className="text-xs sm:text-sm text-kic-gray/70">Visualizations</p>
                  <p className="text-lg sm:text-lg font-semibold text-kic-gray">156</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-kic-green-200 bg-white/80 backdrop-blur-sm shadow-lg border-0">
            <CardContent className="p-3 sm:p-4">
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
                <TrendingUp className="h-5 w-5 sm:h-6 sm:w-6 text-kic-green-600 flex-shrink-0" />
                <div className="text-center sm:text-left">
                  <p className="text-xs sm:text-sm text-kic-gray/70">Accuracy Rate</p>
                  <p className="text-lg sm:text-lg font-semibold text-kic-gray">94.2%</p>
                </div>
              </div>
            </CardContent>
          </Card>
