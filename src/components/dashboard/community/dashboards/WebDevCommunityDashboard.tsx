      ...
      <div className="container mx-auto p-4 sm:p-6 w-full max-w-none">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full sm:w-auto">
                <div className="p-3 rounded-full bg-kic-green-100 flex-shrink-0">
                  <Globe className="h-6 w-6 sm:h-8 sm:w-8 text-kic-green-600" />
                </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
            ...
            <CardContent className="p-3 sm:p-4">
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
                ...
                <div className="text-center sm:text-left">
                  <p className="text-xs sm:text-sm text-kic-gray/70">Active Repos</p>
                  <p className="text-lg sm:text-lg font-semibold text-kic-gray">15</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-kic-green-200 bg-white/80 backdrop-blur-sm shadow-lg border-0">
            <CardContent className="p-3 sm:p-4">
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
                <Palette className="h-5 w-5 sm:h-6 sm:w-6 text-kic-green-600 flex-shrink-0" />
                <div className="text-center sm:text-left">
                  <p className="text-xs sm:text-sm text-kic-gray/70">Design Systems</p>
                  <p className="text-lg sm:text-lg font-semibold text-kic-gray">4</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-kic-green-200 bg-white/80 backdrop-blur-sm shadow-lg border-0">
            <CardContent className="p-3 sm:p-4">
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
                ...
                <div className="text-center sm:text-left">
                  <p className="text-xs sm:text-sm text-kic-gray/70">APIs Built</p>
          ...
          <Card className="border-kic-green-200 bg-white/80 backdrop-blur-sm shadow-lg border-0">
            <CardContent className="p-3 sm:p-4">
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
                <Globe className="h-5 w-5 sm:h-6 sm:w-6 text-kic-green-600 flex-shrink-0" />
                <div className="text-center sm:text-left">
                  <p className="text-xs sm:text-sm text-kic-gray/70">Live Sites</p>
                  <p className="text-lg sm:text-lg font-semibold text-kic-gray">9</p>
                </div>
              </div>
            </CardContent>
          </Card>
